...
class PeliculasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pelicula" do
    assert_difference('Pelicula.count') do
      post peliculas_url, params: { pelicula: { año: @pelicula.año, calidad: @pelicula.calidad, categoria: @pelicula.categoria, nombre: @pelicula.nombre, synopsis: @pelicula.synopsis, url: @pelicula.url } }
    end
  ...
  test "should update pelicula" do
    patch pelicula_url(@pelicula), params: { pelicula: { año: @pelicula.año, calidad: @pelicula.calidad, categoria: @pelicula.categoria, nombre: @pelicula.nombre, synopsis: @pelicula.synopsis, url: @pelicula.url } }
